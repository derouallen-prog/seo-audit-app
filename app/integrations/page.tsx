...
function WordPressLogo() {
  return <Image src="/logos/wordpress.png" alt="WordPress" width={32} height={32} className="h-8 w-8 rounded object-contain" />;
}

function WooCommerceLogo() {
  return <Image src="/logos/wordpress.png" alt="WooCommerce" width={32} height={32} className="h-8 w-8 rounded object-contain" />;
}
...
function WebflowLogo({ className }: { className?: string }) {
  return <Image src="/logos/webflow.png" alt="Webflow" width={32} height={32} className={className ?? "h-8 w-8 rounded object-contain"} />;
}
