              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="bg-brand text-white">
                    <th className="py-2 px-2 sm:px-3 font-semibold text-xs uppercase tracking-wide text-left">Mot-clé</th>
                    <th className="py-2 px-2 sm:px-3 font-semibold text-xs uppercase tracking-wide text-right">Volume</th>
                    <th className="py-2 px-2 sm:px-3 font-semibold text-xs uppercase tracking-wide text-right">KD</th>
                    <th className="py-2 px-2 sm:px-3 font-semibold text-xs uppercase tracking-wide text-left">Intention</th>
                ...
                <tbody>
                  {result.mots_cles_secondaires.map((kw, i) => (
                    <tr key={i} className="border-b border-gray-100 last:border-0 odd:bg-white even:bg-gray-50">
                      <td className="py-1.5 px-2 sm:px-3 font-medium text-black">{kw.keyword}</td>
                      <td className="py-1.5 px-2 sm:px-3 text-right text-gray-700">{kw.volume.toLocaleString("fr-FR")}</td>
                      <td className="py-1.5 px-2 sm:px-3 text-right"><KdBadge kd={kw.kd} /></td>
                      <td className="py-1.5 px-2 sm:px-3 text-gray-500 text-xs">{kw.intent}</td>
